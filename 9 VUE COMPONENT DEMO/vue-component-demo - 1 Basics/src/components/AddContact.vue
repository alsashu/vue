...
function addContact() {
  ...
  emit('add-contact', { name: contact.name, phone: contact.phone, email: contact.email, ownerName: "SDG's-Owner", id: randomNumber, address: "SDG Bangalore", role: "SSE", isFavorite: false });
